//
//  TablaDetalleJugueteController.swift
//  Menu
//
...
class TablaDetalleJugueteController: UITableViewController {
    var juguetes = [
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celdaJuguete", for: indexPath) as! TablaDetalleJugueteCell
            
        let juguete = juguetes[indexPath.row]
        cell.imagen.image = UIImage(named:juguete.imagen!)
